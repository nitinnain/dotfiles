return {
  ...
  },
  {
    ...
    dependencies = {
      ...
      'WhoIsSethDaniel/mason-tool-installer.nvim', -- CHECK Is this auto-update slowing nvim down?
        ...
        virtual_taext = {
          ...
          format = function(diagnostic)
            local diagnostic_message = {
              ...
              -- [vim.diagnostic.severity.HINT] = diagnostic.message,  -- too many type hints, especially with basedpyright
            }
